...
const SelectedRide = ({rides}) => {
    ...
    console.log(rides)
    const rideData=rides.find((ride)=>(ride.vehicleId===vehicleId))
    ...
    findLocation ?
        ...
        <Card style={{ "background": "lightgray" }} className="col-md-3 h-25">
           ...
           <Card.Body>
              ...
              <Card body className="bg-info mb-4"><h3>Mirpur-1 </h3><br />
                  <h3>Dhanmondi </h3>
              </Card>

              <ListGroup variant="flush">
                  <Card body className="mb-4">hello</Card>
